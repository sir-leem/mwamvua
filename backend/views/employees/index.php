...
<div class="employees-index" style="padding-top: 40px;padding-left: 10px">
        ...
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                ...
                <ul class="nav nav-tabs">
                    <li class="active"><a href="#tab_administrator" data-toggle="tab" class="fa fa-user"><b> Administrator</b></a></li>
                    <li><a href="#tab_office_staff" data-toggle="tab" class="fa fa-user"><b> Office Staff</b></a></li>
                    <li><a href="#tab_employee_id" data-toggle="tab" class="fa fa-user"><b> Port Users</b></a></li>
                    <li><a href="#tab_employee_id" data-toggle="tab" class="fa fa-user"><b> Boarder Users</b></a></li>
                    <li><a href="#tab_employee_id" data-toggle="tab" class="fa fa-user"><b> Office Staff</b></a></li>
                ...
                <div class="tab-content">
                    <div class="box-body table-responsive">
                        <div class="tab-content" style="padding-top: 2%">
                            <div class="tab-pane active" id="tab_administrator">

                                <p style="padding-top: 1%" />
                                <div class="col-md-6">
                                    <strong class="lead" style="color: #01214d;font-family: Tahoma"> <i class="fa fa-users"></i> RAHNTECH
                                ...
                                <div class="col-md-6">
                                    <?php if (Yii::$app->user->can('createUser')) { ?>
                                        <?= Html::a(Yii::t('app', '<i class="fa fa-user-plus"></i> Add New'), ['create'], ['class' => 'btn btn-primary waves-effect waves-light']) ?>
                                    <?php } ?>
                                </div>
                                <p style="padding-top: 1%" />
                            ...
                            <div class="tab-pane" id="tab_office_staff">
                                ...
                                <div class="col-md-6">
                                    <strong class="lead" style="color: #01214d;font-family: Tahoma"> <i class="fa fa-users"></i> RAHNTECH
                                        COMPANY LTD - Employees List</strong>
                                </div>
                                <div class="col-md-2">
                            ...
                            <div class="tab-pane" id="tab_company_id">
                                <hr/>
                                <div class="col-md-6">
                                    <strong class="lead" style="color: #01214d;font-family: Tahoma"> <i class="fa fa-home"></i> RAHNTECH
                                        COMPANY LTD - BILL Company Users</strong>
                                </div>
