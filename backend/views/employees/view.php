    ...
    <div class="row bg-info" style="padding: 10px">
        ...
        <div class="col-md-3">
            <?php if (Yii::$app->user->can('createUser')) { ?>
                <?= Html::a(Yii::t('app', '<i class="fa fa-pencil"> Edit</i>'), ['employees/update', 'id' => $model->id], ['class' => 'btn btn-primary', 'data-toggle' => "tooltip", 'rel' => "tooltip", 'title' => "Update",]) ?>
            <?php } ?>
            <?= Html::a(Yii::t('app', '<i class="fa fa-backward"> go Back</i>'), ['employees/index'], ['class' => 'btn btn-warning', 'data-toggle' => "tooltip", 'rel' => "tooltip", 'title' => "Cancel",]) ?>
