    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            ...
            if ($model->isNewRecord) {
                ...
                <div class="col-sm-6">
                    <?= $form->field($user, 'role')->dropDownList(\backend\models\User::getRulesBorderStaff(), ['prompt' => '-- select User Roles --']) ?>
                </div>
                <div class="col-sm-6">
                    <?php $form->field($user, 'user_type')->dropDownList(\backend\models\User::getUserType(), ['prompt' => '-- select User Type --']) ?>
                </div>
                <div class="col-sm-6">
