    ...
    <div class="nav-tabs-custom">
        ...
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                ...
                <ul class="nav nav-tabs">
                    <li class="active"><a href="#tab_awaiting_receive_report_id" data-toggle="tab"
                                          class="fa fa-database"><b> Awaiting Receive</b></a></li>
                    <li><a href="#tab_received_device_id" data-toggle="tab" class="fa fa-info-circle"><b> Received</b></a></li>

                    <li><a href="#tab_available_device_id" data-toggle="tab" class="fa fa-recycle"><b> Available</b></a></li>
                    <li><a href="#tab_released_device_id" data-toggle="tab" class="fa fa-recycle"><b> Released</b></a></li>
                    <li><a href="#tab_in_transit_device_id" data-toggle="tab" class="fa fa-location-arrow"><b> On Road</b></a>
                    </li>
                    <li><a href="#tab_sales_trips_id" data-toggle="tab" class="fa fa-money"><b> Sales Trip</b></a></li>
                    <li><a href="#tab_trip_per_sales_id" data-toggle="tab" class="fa fa-external-link-square"><b> Trip per Device</b></a></li>
                    ...
                    <div class="box-body table-responsive">
                        <div class="tab-content" style="padding-top: 2%">
                            ...
                            <div class="tab-pane active" id="tab_awaiting_receive_report_id">
                                ...
                                ?>
                                <?php echo $this->render('_searchAwaitingReceiveReport', ['model' => $searchModel]); ?>
                                <?php
                                $pdfHeader = [
                                    'L' => [
                            ...
                            <div class="tab-pane" id="tab_available_device_id">
                                ...
                                $dataProvider = $searchModel->search(Yii::$app->request->queryParams);
                                ?>
                                <?php echo $this->render('_searchAvailableDeviceReport', ['model' => $searchModel]); ?>
                                <?php
                                $pdfHeader = [
                                    'L' => [
                                        'content' => 'RAHNTECH SALES',
                                ...
                                echo \kartik\grid\GridView::widget([
                                    ...
                                    'panel' => [
                                        ...
                                        'heading' => 'LIST OF STOCK AVAILABLE DEVICES',
                            ...
                            <div class="tab-pane" id="tab_sales_trips_id">
                                <div class="col-md-6" style="padding-bottom: 1%">
                                    <strong class="lead" style="color: #01214d;font-family: Tahoma"> <i class="fa fa-money"></i> RAHNTECH
                                ...
                                $gridColumns = [
                                    ...
                                    [
                                        ...
                                        'value' => function ($model) {
                                            if ($model->vehicle_type_id == 2) {

                                                return 'CREDIT PAYMENT';
                                            } elseif ($model->vehicle_type_id ==1) {
                                                return 'CASH PAYMENT';
                                            }
                                        }
                                    ],
                            ...
                            <div class="tab-pane" id="tab_in_transit_device_id">
                                <div class="col-md-6" style="padding-bottom: 1%">
                                    <strong class="lead" style="color: #01214d;font-family: Tahoma"> <i class="fa fa-location-arrow"></i> RAHNTECH
                                ...
                                $dataProvider = $searchModel->search(Yii::$app->request->queryParams);
                                ?>
                                <?php echo $this->render('_searchInTransitReport', ['model' => $searchModel]); ?>
                                <?php
                                $pdfHeader = [
                                    'L' => [
                                        'content' => 'RAHNTECH SALES',
                            ...
                            <div class="tab-pane" id="tab_fault_devices_id">
                                <div class="col-md-6" style="padding-bottom: 1%">
                                    <strong class="lead" style="color: #01214d;font-family: Tahoma"> <i class="fa fa-check-square"></i> RAHNTECH
