    ...
    <div class="nav-tabs-custom">
        <ul class="nav nav-tabs">
            ...
            <ul class="nav nav-tabs">
                ...
                <li class="active"><a href="#tab_available_device_id" data-toggle="tab" class="fa fa-recycle"><b> Available</b></a>
                </li>
            ...
            <div class="tab-content">
                <div class="box-body table-responsive">
                    <div class="tab-content" style="padding-top: 2%">
                        ...
                        <div class="tab-pane active" id="tab_available_device_id">
                            <div class="col-md-6" style="padding-bottom: 1%">
