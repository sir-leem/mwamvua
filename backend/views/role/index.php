    ...
    <div class="nav-tabs-custom">
        ...
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                ...
                <!-- Custom Tabs -->
                <ul class="nav nav-tabs">
                    <li class="active"><a href="#tab_user_role" data-toggle="tab" class="fa fa-lock"><b> User Roles</b></a>
                    </li>
                    <li><a href="#tab_user_permissions" data-toggle="tab" class="fa fa-lock"><b>
                                Permissions</b></a></li>
                </ul>
                <div class="tab-content">
                    <div class="box-body table-responsive">
                        <div class="tab-content" style="padding-top: 2%">
                            ...
                            <div class="tab-pane active" id="tab_user_role">
                                <div class="col-md-6">
                            ...
                            <div class="tab-pane" id="tab_user_permissions">
                                <div class="col-md-6">
                                    <strong class="lead" style="color: #01214d;font-family: Tahoma"> <i
                                                class="fa fa-lock"></i> RAHNTECH
                                        ...
                                        'columns' => [
                                            ...
                                            [
                                                ...
                                                'urlCreator' => function ($action, $model, $key, $index) {
                                                    ...
                                                    switch ($action) {
                                                        case 'view':
                                                            $link = Yii::$app->getUrlManager()->createUrl(['auth-item/view', 'id' => $model->name]);
                                                            break;
                                                        case 'update':

                                                            $link = Yii::$app->getUrlManager()->createUrl(['auth-item/update', 'id' => $model->name]);
                                                            break;
                                                        case 'delete':
                                                            $link = Yii::$app->getUrlManager()->createUrl(['auth-item/delete', 'id' => $model->name]);
                                                            break;
                                                    }
                                                    return $link;
                                                },
