        ...
        <div id="collapse_available_device_Report" class="panel-collapse collapse">
            <div class="panel panel-body" style="background: #EEE">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <?= $form->field($model, 'serial_no')->textarea(['id' => 'serial_available_devices_report', 'rows' => 8, 'placeholder' => 'Search serial number']) ?>
                    </div>
                    <div class="col-md-8">
...
<script type="text/javascript">
    jQuery(document).ready(function () {
        validateNumbers();
        $('#serial_available_devices_report').keyup(function () {
