...
<div class="border-port-index" style="padding-top: 3%">
    ...
    <div class="nav-tabs-custom">
        <ul class="nav nav-tabs">
            ...
            <ul class="nav nav-tabs">
                <li class="active"><a href="#tab_border_id" data-toggle="tab"
                                      class="fa fa-database"><b> Border name</b></a></li>
                <li><a href="#tab_sales_point_id" data-toggle="tab" class="fa fa-info-circle"><b> Sales
                            Point</b></a></li>
            ...
            <div class="tab-content">
                <div class="box-body table-responsive">
                    <div class="tab-content" style="padding-top: 2%">
                        <div class="tab-pane active" id="tab_border_id">
                            <div class="row">
                                <div class="col-md-6">
                        ...
                        <div class="tab-pane" id="tab_sales_point_id">
