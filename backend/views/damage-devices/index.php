...
/* @var $searchModel backend\models\DamageDevicesReportSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Damage Devices';
...
<div class="received-devices-index" style="padding-top: 2%">
    ...
    <center style="padding-top: 20px">
        <?php if (Yii::$app->user->can('makeAvailableDevices')) { ?>
            <?= Html::beginForm(['damage-devices/available'], 'post'); ?>
    ...
    $gridColumns = [
        ...
        [
            'attribute' => 'status',
            'value' => function () {
                if (\backend\models\DamageDevices::damage_device) {
                    return "DAMAGE DEVICE";
                }
            }
        ],
