...
$this->title = '';
$this->params['breadcrumbs'][] = 'Companies';
?>
<div class="companies-index" style="padding-top: 40px;padding-left: 10px">
    ...
    <div class="nav-tabs-custom">
        <ul class="nav nav-tabs">
            ...
            <ul class="nav nav-tabs">
                <li><a href="#tab_employee_id" data-toggle="tab"><b>Employees</b></a></li>
                <li class="active"><a href="#tab_company_id" data-toggle="tab"><b>BILL Customers</b></a></li>

            </ul>
            <div class="tab-content">
                <div class="box-body table-responsive">
                    <div class="tab-content" style="padding-top: 2%">
                        <div class="tab-pane" id="tab_employee_id">
                        ...
                        <div class="tab-pane active" id="tab_company_id">
                            <p style="padding-top: 1%"/>
