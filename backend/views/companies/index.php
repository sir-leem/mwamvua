    ...
    <div class="nav-tabs-custom">
        <ul class="nav nav-tabs">
            ...
            <ul class="nav nav-tabs">
                ...
                <li><a href="#tab_border_staff" data-toggle="tab" class="fa fa-user"><b> Boarder Users</b></a></li>
                <li class="active"><a href="#tab_company_id" data-toggle="tab" class="fa fa-user"><b> Credit Customers</b></a></li>
            ...
            <div class="tab-content">
                <div class="box-body table-responsive">
                    <div class="tab-content" style="padding-top: 2%">
                        ...
                        <div class="tab-pane" id="tab_border_staff">
